...
# Boxplot between patients and controls of all module eigengenes
...
plot <- ggplot(boxplot_df, aes(x = Condition, y = Eigengene, fill = Condition)) +
  geom_boxplot(outlier.shape = NA, alpha = 0.7) +
  stat_compare_means(method = "wilcox.test") +
  scale_y_continuous(expand = expansion(mult = c(0.05, 0.2))) +
  facet_wrap(~ Module, scales = "free_y") +
  theme_bw() +
  labs(title = "Module Eigengene Expression: Patients vs Controls", x = "", y = "Module Eigengene") +
  theme(strip.text = element_text(face = "bold"), legend.position = "right")
dev.copy(png, filename = "wgcna/FRDA_All_Batches_gene_filtered/boxplot_modules.png", width = 2000, height = 1500, res = 150)
dev.off()
...
# Patient stratification using consistent gene expression profiles
```{r, eval=FALSE}
